...
<body>
	<div class="my-header wm-title">
		<img class="my-photo" src="<?php echo $_SESSION['userheadimg'] ?>">
		<span class="my-name"><?php echo $_SESSION['user_name'] ?></span>
	</div>
	<div class="content xys-content footer-fix">
		<div class="menu shadow">
			...
			<div class="menu-item split-top" onclick="location.href='<?php echo site_url("address/manage_address")?>?action=0';">
