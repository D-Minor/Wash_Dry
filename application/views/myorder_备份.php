			...
			?>
				<div class="panel shadow">
					<div class="panel-title">
						...
						<?php 
						if($value['pflag']=='0') echo "<span class='txt order-status'>未支付</span>"; 
						else echo "<span class='txt order-status order-sucess'>已支付</span>"
						?>
					</div>
					...
					<div class="panel-footer">
						...
						<button class="btn btn-xs" onclick="cancelOrder('<?php echo $value['billid']; ?>');">取消订单</button>
					</div>				
				</div>
				<?php
					}
